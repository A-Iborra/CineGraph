...
### Code pour voir les tables de la base movies
import sqlite3
...
### Données kaggle ---------------------------------------------------------------------------------------------------
data_kaggle = pd.read_csv('data/movie_statistic_dataset.csv')
data_kaggle.to_sql('raw_kaggle', engine, if_exists='replace', index=False)

### Données allociné  ------------------------------------------------------------------------------------------------

## Données octobre 2021
